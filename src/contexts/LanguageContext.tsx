...
const translations: Record<string, Record<Language, string>> = {
  ...
  "about.roles": { en: "Project Coordinator · Volunteer Coordinator · Trainer · Founder of PINECO", pl: "Koordynatorka projektów · Koordynatorka wolontariatu · Trenerka · Założycielka PINECO" },
  ...
  "about.bio2": { en: "In 2019, I co-founded Association LEVEL UP, a Polish nonprofit dedicated to improving quality of life through social projects and volunteering. I specialise in international programmes funded under Erasmus+ and ESC. That experience — building something meaningful from scratch, across borders, with limited resources — is exactly what shaped the work I do today.", pl: "W 2019 roku współzałożyłam Stowarzyszenie LEVEL UP — polską organizację pozarządową dedykowaną poprawie jakości życia poprzez projekty społeczne i wolontariat. Specjalizuję się w programach międzynarodowych finansowanych ze środków Erasmus+ i ESC. To doświadczenie — budowanie czegoś wartościowego od podstaw, ponad granicami, przy ograniczonych zasobach — ukształtowało moją dzisiejszą pracę." },
  ...
  "services.page.projectPricing": { en: "Individual pricing — scope and hours agreed together.", pl: "Cena ustalana indywidualnie — zakres i godziny ustalamy wspólnie." },
  "services.page.projectPricingNote": { en: "Every project is different. Get in touch and we'll figure out what works.", pl: "Każdy projekt jest inny. Napisz, a ustalimy co będzie najlepsze." },
  "services.page.getQuote": { en: "Get in touch →", pl: "Skontaktuj się →" },
  ...
  "services.page.volPricing": { en: "Individual pricing · Free 30-minute consultation included", pl: "Ustalane indywidualnie · Bezpłatna konsultacja 0,5h w cenie" },
  "services.page.volPricingNote": { en: "Start with a free consultation — no strings attached.", pl: "Zacznij od bezpłatnej konsultacji — bez zobowiązań." },
  ...
  "services.page.trainingPrice": { en: "£80–£100/h", pl: "160–220 zł/h" },
  "services.page.trainingPricing": { en: "depending on the topic · travel costs apply for in-person sessions", pl: "w zależności od tematu · koszty dojazdu przy sesjach stacjonarnych" },
  ...
  "services.page.consultingPrice": { en: "from £50/h", pl: "od 150 zł/h" },
  "services.page.consultingPricingNote": { en: "First 30 minutes free — no commitment needed.", pl: "Pierwsza 0,5h bezpłatna — bez zobowiązań." },
  "services.page.bookConsulting": { en: "Book a Free Consultation", pl: "Umów bezpłatną konsultację" },
};
