  ...
  return (
    <section className="relative flex items-center overflow-hidden py-32 md:py-40 lg:py-48">
      <div className="absolute inset-0">
        <img src={heroImage} alt="PINECO consultancy team collaborating" className="w-full h-full object-cover" />
      ...
      <div className="relative container mx-auto px-4 lg:px-8 pt-20">
        <div className="max-w-2xl">
          ...
          <motion.p initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, delay: 0.2 }} className="text-lg md:text-xl text-primary-foreground/80 mb-10 leading-relaxed max-w-lg">
            {t("hero.subtitle")}
          </motion.p>
